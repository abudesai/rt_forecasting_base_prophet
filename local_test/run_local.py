...
def train_and_save_algo():        
    ...
    model, data_preprocessor = model_trainer.get_trained_model(train_data, data_schema, hyper_parameters)            
    # Save the training artifacts
    model_trainer.save_training_artifacts(model, data_preprocessor, model_artifacts_path) 
